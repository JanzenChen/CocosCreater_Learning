cc.Class({
    ...
    toMove (){
        ...
        cc.log(this.curTilePosX + ' ' + this.curTilePosY);
        ...
        this.node.runAction(
            cc.sequence(
                ...
                cc.moveBy(
                    this.radio * ((dir.dx != 0) && (dir.dy != 0) ? 1.4 : 1) / 0.5, 
                    -(dir.dx+dir.dy)*32, 
                     (dir.dy-dir.dx)*24
                ),
    ...
    onLoad: function () {
        ...
        this.node.on('mouseup', function(event){
            ...
            //this.toMoveOnce();
            this.toMove();
            var newPos = util.convertTo45(event);
            self.curTilePosX = newPos.newX;
            self.curTileY = newPos.newY;
        },this);
